                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Multi Columns Form -->
                            <form id="formEditKontrakan" class="row g-3" action="{{ route('dashboard.rents.update', $rent->id) }}"
                                ...
                                <div class="col-md-8 offset-md-2">
                                    ...
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="status_kontrakan"
                                            value="Kosong"
                                            {{ old('status_kontrakan', $rent->status_kontrakan) == 'Kosong' ? 'checked' : '' }}
                                            id="gridRadios3">
                                    ...
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="status_kontrakan"
                                            value="Booking"
                                            {{ old('status_kontrakan', $rent->status_kontrakan) == 'Booking' ? 'checked' : '' }}
                                            id="gridRadios4">
                                    ...
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="status_kontrakan"
                                            value="Penuh"
                                            {{ old('status_kontrakan', $rent->status_kontrakan) == 'Penuh' ? 'checked' : '' }}
                                            id="gridRadios5">
                                ...
                                <div class="col-md-8 offset-md-2">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tipe_kontrakan" value="Bulanan"
                                            id="gridRadios1"
                                            {{ old('tipe_kontrakan', $rent->tipe_kontrakan) == 'Bulanan' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="gridRadios1">Bulanan</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tipe_kontrakan" value="Tahunan"
                                            {{ old('tipe_kontrakan', $rent->tipe_kontrakan) == 'Tahunan' ? 'checked' : '' }}
                                            id="gridRadios2">
