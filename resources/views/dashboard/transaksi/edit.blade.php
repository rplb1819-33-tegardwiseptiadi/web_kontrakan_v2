              ...
              <div class="row">
                  ...
                  <div class="col-lg-12">
                      <div class="row">
                          ...
                          <div class="card">
                              <div class="card-body">
                                  <h5 class="card-title" style="text-align: center;">UPDATE DATA TRANSAKSI</h5>
                                  <!-- Multi Columns Form -->
                                  <form id="formEditTransaksi" class="row g-3"
                                      ...
                                      {{-- Nama Transaksi  --}}
                                      <div class="col-md-10">
                                          <label for="selectNamaUser" class="form-label">Transaksi Atas Nama
                                              :</label>

                                          <!-- Input teks yang readonly untuk menampilkan nama pengguna -->
                                          <input type="text" class="form-control"
                                              value="{{ old('nama_user', $transaction->user->name) }}" readonly>

                                          <!-- Input tersembunyi untuk menyimpan user_id yang sebenarnya -->
                                      ...
                                      <div class="col-md-10">
                                          ...
                                          <input type="number" class="form-control" id="harga_perbulan"
                                              name="harga_perbulan" readonly
                                              value="{{ old('harga_perbulan', $transaction->harga_perbulan) }}">
                                      </div>
                                      ...
                                      <div class="col-md-10" id="input_uang_bayar">
